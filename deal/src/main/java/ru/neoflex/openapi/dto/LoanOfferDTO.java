...
public class LoanOfferDTO  implements Serializable {
  ...
  */
  @NotNull @Min(1L) 
  @Schema(name = "applicationId", example = "1", description = "Id of application", required = true)
  ...
  */
  ...
  @Schema(name = "requestedAmount", example = "10000.0", description = "Requested loan amount", required = true)
  ...
  */
  @NotNull @Valid @DecimalMin("10000.0") 
  @Schema(name = "totalAmount", example = "10150.0", description = "Total loan amount", required = true)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "monthlyPayment", example = "1756.38", description = "Monthly payment", required = true)
  ...
  */
  @NotNull @Valid 
  @Schema(name = "rate", example = "13", description = "Rate", required = true)
